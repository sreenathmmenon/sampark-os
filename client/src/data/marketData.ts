// ═══════════════════════════════════════════════════════════
// SAMPARK-OS: Real Kerala Market Data Configuration
// Location: client/src/data/marketData.ts
// ═══════════════════════════════════════════════════════════
...
export const LANGUAGES: Language[] = [
  ...
  { code: "hi", name: "Hindi", nativeName: "हिन्दी", region: "Pan-India" },
...
// ─── AGENT COLORS ───────────────────────────────────────────
export const AGENT_COLORS: Record<string, { color: string; label: string }> = {
  SCOUT: { color: "#22d3ee", label: "cyan" },
  NEGOTIATOR: { color: "#00ff88", label: "green" },
  AUDITOR: { color: "#ff3b5c", label: "red" },
  NAVIGATOR: { color: "#ffb800", label: "amber" },
  COORDINATOR: { color: "#a78bfa", label: "purple" },
};

// ─── UTILITY FUNCTIONS ──────────────────────────────────────
export function getFishName(speciesId: string, langCode: string): string {
  const fish = FISH_SPECIES[speciesId];
  if (!fish) return speciesId;
  ...
  return map[langCode] || fish.english;
}
